...
## [2026-09-06] v1.6.1 - 日麻点数工具重构

### 修复

- 修正自摸本场加算、双立直/里宝牌、一发状态，以及荣和双碰的符数与三暗刻判定
- 计算入口统一校验手牌总数、牌面范围、副露结构与四张上限，拒绝非法牌面
- 修正混全带幺九、纯全带幺九的顺子条件，并过滤副露对等待型的干扰
- 修正结果层的自摸/荣和支付字段与满贯等级文案

### 优化

- 重做日麻点数页面：牌局摘要、牌桌式手牌编辑、可收起牌盘、分组设置与可滚动结果抽屉
- 牌盘限制同牌最多四张，赤五不再作为宝牌指示牌，特殊状态随自摸/荣和联动
- 增加本场、双立直、严格牌面和副露边界的回归测试
